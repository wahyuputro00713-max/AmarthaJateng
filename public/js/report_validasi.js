...
function setupFormListeners() {
    ...
    if (elForm) {
        elForm.addEventListener('submit', async (e) => {
            ...
            try {
                const file = document.getElementById('fotoInput').files[0]; // Ambil file pertama saja (sesuai logika backend saat ini)
                ...
                if (result.result === 'success') {
                    // --- BERHASIL ---
                    alert("✅ Data Validasi Berhasil Terkirim!");
                    
                    // 1. Simpan Data User Agar Tidak Hilang Saat Reset
                    ...
                    // 3. Kembalikan Data User ke Form
                    setTanggalOtomatis();
                    ...
                    // CATATAN: Tidak ada window.location.href = "home.html", jadi tetap di halaman ini.
